...
/* harmony import */ var _modules_page_header__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/page-header */ "./js/modules/page-header.js");
/* harmony import */ var _modules_form_validate_form_success_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/form-validate/form-success.js */ "./js/modules/form-validate/form-success.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    var pageHeader = new _modules_page_header__WEBPACK_IMPORTED_MODULE_5__["PageHeader"]();
    pageHeader.init();
    Object(_modules_form_validate_form_success_js__WEBPACK_IMPORTED_MODULE_6__["formSendSuccess"])();
  });
});
...
/***/ "./js/modules/form-validate/form-success.js":
/*!**************************************************!*\
  !*** ./js/modules/form-validate/form-success.js ***!
  \**************************************************/
/*! exports provided: formSendSuccess */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formSendSuccess", function() { return formSendSuccess; });
var formSendSuccess = function formSendSuccess() {
  var formContainer = document.querySelector('.form');
  var formMessage = formContainer.querySelector('.form__message');
  var requiredInput = formContainer.querySelector('[data-required]');
  ...
  function handleFormSubmitSuccess(evt) {
    evt.preventDefault();
    var inputIsValid = requiredInput.classList.contains('is-valid');
    if (!inputIsValid) {
      return;
    }
...
var PageHeader = /*#__PURE__*/function () {
  ...
  _createClass(PageHeader, [{
    ...
    key: "onHeaderTogglerClick",
    value: function onHeaderTogglerClick(evt) {
      evt.preventDefault();
    ...
    value: function onDocumentKeydown(evt) {
      evt.preventDefault();
      if (evt.key === 'Escape') {
        this.closeHeader();
      }
